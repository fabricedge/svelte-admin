      ...
      {:else}
        <div class="space-y-3">
          {#each recentOrders as order}
            <a href={`/admin/${page.params.slug}/orders/${order.id}`} class="flex items-center justify-between py-2 border-b border-gray-100 last:border-0 hover:bg-gray-50 -mx-2 px-2 rounded">
              <div>
